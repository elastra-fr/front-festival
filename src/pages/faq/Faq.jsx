...
<FaqItem titre="Hebergement" contenu={["Hôtels : Nous avons des partenariats avec plusieurs hôtels à proximité du festival. Consultez notre site web pour plus d&apos;informations sur les hébergements recommandés.", "Camping : Le camping sur place est disponible pour les détenteurs de billets appropriés. Des emplacements pour tentes et camping-cars seront disponibles. Veuillez consulter nos règles et règlements concernant le camping avant votre arrivée."]}/>
