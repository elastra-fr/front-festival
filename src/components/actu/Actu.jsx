...
console.log(nbperpage);
  ...
  const getActu = () => {
    fetch("https://www.api.nationsound2024-festival.fr/wp-json/wp/v2/actus?per_page="+nbperpage)
  ...
  return (
    <>
      <div className="mainActu">
        ...
        {location==="/home"?<Link to="/fullactu" className="lienFullActu">Voir l'actu complète du festival</Link>:""}
